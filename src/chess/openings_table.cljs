...
(def openings-table #{
                      ...
                      {:board-state "rnbqkbnr/pp1p1ppp/4p3/2p5/4PP2/8/PPPP2PP/RNBQKBNR w KQkq -" :name "sicilian" :next-algebraic-move "-f3"}
                      {:board-state "rnbqkbnr/pp1p1ppp/4p3/2p5/4PP2/5N2/PPPP2PP/RNBQKB1R b KQkq -" :name "sicilian" :next-algebraic-move "-d5"}
                      {:board-state "rnbqkbnr/pp3ppp/4p3/2pp4/4PP2/5N2/PPPP2PP/RNBQKB1R w KQkq d6" :name "sicilian" :next-algebraic-move "-b5"}
                      {:board-state "rnbqkbnr/pp3ppp/4p3/1Bpp4/4PP2/5N2/PPPP2PP/RNBQK2R b KQkq -" :name "sicilian" :next-algebraic-move "-d7"}
                      {:board-state "rn1qkbnr/pp1b1ppp/4p3/1Bpp4/4PP2/5N2/PPPP2PP/RNBQK2R w KQkq -" :name "sicilian" :next-algebraic-move "-d7"}
                      {:board-state "rn1qkbnr/pp1B1ppp/4p3/2pp4/4PP2/5N2/PPPP2PP/RNBQK2R b KQkq -" :name "sicilian" :next-algebraic-move "-d7"}
                      {:board-state "r2qkbnr/pp1n1ppp/4p3/2pp4/4PP2/5N2/PPPP2PP/RNBQK2R w KQkq -" :name "sicilian" :next-algebraic-move "-d3"}
                      {:board-state "r2qkbnr/pp1n1ppp/4p3/2pp4/4PP2/3P1N2/PPP3PP/RNBQK2R b KQkq -" :name "sicilian" :next-algebraic-move "-d6"}
                      {:board-state "r2qk1nr/pp1n1ppp/3bp3/2pp4/4PP2/3P1N2/PPP3PP/RNBQK2R w KQkq -" :name "sicilian" :next-algebraic-move "-c4"}
                      {:board-state "r2qk1nr/pp1n1ppp/3bp3/2pp4/2P1PP2/3P1N2/PP4PP/RNBQK2R b KQkq c3" :name "sicilian" :next-algebraic-move "-e7"}
