...
(def openings-table #{{:board-state "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq -" :name "sicilian" :next-algebraic-move "e2-e4"}
                      ...
                      {:board-state "r2qk1nr/pp1n1ppp/3bp3/2pp4/2P1PP2/3P1N2/PP4PP/RNBQK2R b KQkq c3" :name "sicilian" :next-algebraic-move "g8-e7"}
                      ...
                      {:board-state "r2q1rk1/pp1nnppp/3bp3/2pp4/2P1PP2/3P1N2/PP4PP/RNBQ1RK1 w - -" :name "sicilian" :next-algebraic-move "b1-c3"}
                      {:board-state "r2q1rk1/pp1nnppp/3bp3/2pp4/2P1PP2/2NP1N2/PP4PP/R1BQ1RK1 b - -" :name "sicilian" :next-algebraic-move "d5-d4"}
                      {:board-state "r2q1rk1/pp1nnppp/3bp3/2p5/2PpPP2/2NP1N2/PP4PP/R1BQ1RK1 w - -" :name "sicilian" :next-algebraic-move "c3-e2"}
                      {:board-state "r2q1rk1/pp1nnppp/3bp3/2p5/2PpPP2/3P1N2/PP2N1PP/R1BQ1RK1 b - -" :name "sicilian" :next-algebraic-move "a7-a6"}})
